...
# -*- coding: utf-8 -*-
"""
This experiment was created using PsychoPy2 Experiment Builder (v1.80.03), Mon Jul 28 12:49:28 2014
...
expName = u'stroopExperiment'  # from the Builder filename that created this script
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath=u'/Users/antonio/Sites/languageguide/stroop/stroopExperiment.psyexp',
...
instrText = visual.TextStim(win=win, ori=0, name='instrText',
    text=u'Remember, choose the colour of the letters, ignoring the word:\n\nleft = red\ndown = green\nright = blue',    font=u'Arial',
...
trials = data.TrialHandler(nReps=5, method=u'random', 
    extraInfo=expInfo, originPath=u'/Users/antonio/Sites/languageguide/stroop/stroopExperiment.psyexp',
...
for thisTrial in trials:
    ...
    frameN = -1
    # update component parameters for each repeat
    target.setColor(colour, colorSpace=u'rgb')
    target.setText(word)
    ...
    while continueRoutine:
        ...
        elif target.status == STARTED and t >= (0.5 + (4.0-win.monitorFramePeriod*0.75)): #most of one frame period left
